...
from shape_producer.channel import ETSM2018, MTSM2018, TTSM2018
...
def parse_arguments():
    ...
    parser.add_argument(
        "--only-inclusive", default=False, type=bool, help="Only produce inclusive shapes, no categorization requiring NN vars.")
